		...
		return (
			<div>
				<div className='navbarDiv'>
					<div className='navbarLogoDiv' style={{ paddingTop: '20px' }}><img src={logo} />
					...
					<div className='menuStandard' style={{ marginLeft: 'auto', paddingRight: '50px' }}>
						<Menu className='menuItem' stackable pointing secondary size='large' style={{ borderBottom: 'none', display: 'center', alignItems: 'center', justifyContent: 'center' }}>
							<a href='#home'><Menu.Item name='Home' active={activeItem === 'Home'} onClick={this.handleItemClick}>Home</Menu.Item></a>
							<a href='#aboutUs'><Menu.Item name='About' active={activeItem === 'About'} onClick={this.handleItemClick}>About</Menu.Item></a>
