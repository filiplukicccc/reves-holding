  ...
  render() {
    return (
      <div style={{ width: '100%', background: 'white',position:'relative' }}>
        <h2 className='managment' style={{ background: 'white',marginBottom:'20px' }}>MANAGMENT</h2>
        <div style={{ textAlign: 'center', display: 'flex', justifyContent: 'center', alignItems: 'center', background: 'white',marginBottom:'50px' }}>
          <span className='border'></span>
          <span style={{ width: '8px', height: '8px', background: '#003571', display: 'inline-block', borderRadius: '50%', margin: '0 20px' }}></span>
          <span className='border'></span>
        </div>
        <Grid style={{ width: '100%', margin: '0px', background: 'white' }}>
          <GridRow centered style={{ background: 'white', margin: '0 auto' }}>
